...
<div id="global-loader">
    <img src="{{asset('/')}}admin/{{asset('/')}}admin/assets/images/loader.svg" class="loader-img" alt="Loader">
</div>
<!-- /GLOBAL-LOADER -->
                ...
                <div class="main-sidemenu">
                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="{{route('brand.add')}}" class="slide-item">Add Brand Category</a></li>
                                <li><a href="{{route('brand.manage')}}" class="slide-item">Manage Brand Category</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="users-list.html" class="slide-item">Add Module</a></li>
                                <li><a href="file-attachments.html" class="slide-item">Manage Module</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
